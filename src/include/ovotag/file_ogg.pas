...
uses
  Classes, lazutf8, SysUtils, AudioTag, baseTag, tag_Vorbis;
...
function TOGGReader.DumpInfo: TMediaProperty;
begin
...
begin
  ...
  for Index := 1 to 50 do
    ...
    for Iterator := SizeOf(Data) - 10 downto 0 do
      if Data[Iterator] + Data[Iterator + 1] + Data[Iterator + 2] + Data[Iterator + 3] = OGG_IDENTIFIER then
        begin
...
begin
  ...
  try
    ...
    FChannelModeID := BlockHeader.ChannelMode;
